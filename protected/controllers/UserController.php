...
class UserController extends TopController{
	...
	public function actionShop(){
		...
		if(!empty($data['error_no'])){
				header("refresh:5;url=http://www.aisoupin.com");
				echo "<div style='width:600px;margin:0 auto;text-align:center;'>".$data['error_info'].",5秒后回自动<a href='http://www.aisoupin.com'>跳转</a>到网站首页</div>";	
			Yii::app()->end();
		}
